    ...
    return GestureDetector(
      ...
      child: IntrinsicWidth(
        ...
        decoration: BoxDecoration(
          color: isSelected ? Colors.transparent : (rankColor ?? colorScheme.surface).withOpacity(0.3),
          borderRadius: BorderRadius.zero,
          border: Border.all(
            color: isSelected ? (rankColor ?? colorScheme.primary) : colorScheme.outline,
            ...
            Padding(
              ...
              child: Text(
                ...
                style: theme.textTheme.bodyMedium?.copyWith(
                  ...
                  color: isSelected ? (rankColor ?? colorScheme.primary) : colorScheme.onSurface,
                ),
                maxLines: 2,
