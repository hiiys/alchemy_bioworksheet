...
class _OrderRegistrationPageState extends State<OrderRegistrationPage> {
  ...
  Future<void> _saveOrder() async {
    ...
    final order = OrderInfo(
      ...
      dateReceived: DateTime.now(), // Set to current date when order is created
      dateAnalysis: null,
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const Text(
                        'Reference ID will be auto-generated by the system',
                        style: TextStyle(
                          fontSize: 12,
                      ...
                      FilledButton(
                        onPressed: () async {
                          ...
                          await appState.addSampleMarking(
                            ...
                            receiveId: null, // Reference ID will be auto-generated by Firebase
